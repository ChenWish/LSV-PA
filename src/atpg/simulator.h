...
public:
    ...
    void eventFaultSim();
    void goodSim(vector<int>* maval = 0);
    void goodSimCopyToFault();
    void goodEval(const int &i, vector<int>* maval = 0);
...
// Date       [ CJY Ver. 1.0 started 2013/08/18 ]
// **************************************************************************
inline void Simulator::goodSim(vector<int>* maval) {
...
inline void Simulator::goodEval(const int &i, vector<int>* maval) {
